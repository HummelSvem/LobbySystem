...
class LobbyItems extends PluginBase implements Listener
{
	...
	public $prefix = TextFormat::YELLOW . "Atarove.net" . TextFormat::GRAY . " | " . TextFormat::WHITE;
	...
	*/
	...
	public function onEnable(): void{
		...
		$this->getServer()->getNetwork()->setName(TextFormat::BOLD . TextFormat::GREEN . "Atarove.net");
	...
	public function onPreLogin(PlayerPreLoginEvent $event)
	{
		...
		if (!$player->isWhitelisted($name)) {
			$msg =
				...
				TextFormat::RESET . TextFormat::GOLD . "Atarove" . TextFormat::GRAY . "|" . TextFormat::RED . " WhiteListed\n" .
	...
	public function onInteract(PlayerInteractEvent $event)
	{
        ...
        if ($in == TextFormat::RESET . Textformat::GREEN . "Duels") {
        	$event->getPlayer()->transfer("play.atarove.de","7000");
        }
       if ($in == TextFormat::RESET . TextFormat::GREEN . "Survival") {
       	$event->getPlayer()->transfer("play.atarove.de","10888");
        } 
        if ($in == TextFormat::RESET . TextFormat::RED . "MainHub") {
        	$event->getPlayer()->transfer("play.atarove.de","19132");
        }
		if ($in == TextFormat::RESET . TextFormat::BLACK . "Clans") {

			//$this->getRangMenu($player);
			$event->getPlayer()->sendMessage($this->prefix . TextFormat::RED . "Benutze: /clan help");
		}
